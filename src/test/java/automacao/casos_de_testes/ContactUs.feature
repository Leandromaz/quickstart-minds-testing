@AutomationPractice @Produto @Contactus
Feature: Preenche e manda o formulario de contato

  Scenario Outline: Envia Formulário de contato
    Given o usuário acessou a home da loja
    And Clica em Contact us
    And Seleciona a opcão Custumer Service
    And Digita o "<email>" no campo email address
